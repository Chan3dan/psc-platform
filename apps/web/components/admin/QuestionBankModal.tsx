  ...
  return (
    <>
      ...
      {open && (
        ...
        >
          <div className="w-full max-w-7xl h-[100dvh] md:h-auto md:max-h-[92vh] overflow-y-auto overscroll-contain card glass rounded-none md:rounded-2xl pb-24 md:pb-0">
